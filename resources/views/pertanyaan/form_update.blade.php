              ...
              @csrf <!-- Jangan lupa @csrf ya! -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="judul" id="judul" placeholder="Masukkan judul" value="{{$pertanyaan->judul}}">
                  </div>
                    <!-- textarea -->
                    <div class="form-group">
                    <label>Isi</label>
                    <textarea class="form-control" name="isi" placeholder="Masukkan pertanyaan" id="isi">{{$pertanyaan->isi}}</textarea>
                    </div>
                </div>
                <!-- /.card-body -->
